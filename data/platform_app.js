(function (root) {
  ...
  function customParameters(cfg) {
    ...
    return (Array.isArray(state.customParameters) ? state.customParameters : [])
  ...
  function bindSetup() {
    ...
    function collectSiteConfig(tpl) {
      ...
      next.customParameters = collectCustomParameters();
    ...
    if (addCustom) addCustom.onclick = function () {
      ...
      Settings.saveConfig({ customParameters: rows });
    ...
    document.querySelectorAll("[data-remove-custom-param]").forEach(function (button) {
      button.onclick = function () {
        ...
        Settings.saveConfig({ customParameters: rows, parameterStandards: standards });
        mount(lastRoot, "settings");
      };
    });
