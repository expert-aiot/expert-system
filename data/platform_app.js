(function (root) {
  ...
  function renderSetup() {
    ...
    return wrap('<section class="' + cardClass() + ' setupDesigner"><div class="' + headClass() + '"><h2>' + esc(l("客戶設定", "Customer Settings")) + '</h2><span class="statusPill ' + (tpl ? "green" : "yellow") + '">' + dot(tpl ? "green" : "yellow") + esc(tpl ? templateLabel(tpl) : l("未選定", "Not selected")) + '</span></div><div class="' + bodyClass() + '"><div class="setupWorkspace">' +
