(function (root) {
  ...
  root.AIOT_DEMO_FIXTURE = {
    ...
    scenario: {
      ...
      forecast: {
        ...
        series: [
          ...
          { offsetHours: 6, value: 5.2, light: "blue" }
        ]
      },
    ...
    ui: { standards: {
      DO: { light: ["yellow", "黃燈"], rows: [["理想區","自動","--","標準"],["警戒區","自動","4.0-5.0","自訂"],["危險線","自動","--","標準"],["權重","自動","--","標準"]], ratio: {blue:5,green:55,yellow:30,orange:5,red:5}, coveragePct:92, card:{title:"夜間餵料調整",badge:"低氧警報",reason:"DO 低於警戒，清晨低氧風險升高。",action:"提前開水車，防止 DO 下降；晚間投餵量下修 30%。",effect:"預估 2 小時回到安全區。",impact:"降低低氧與殘餌風險。信心：低（fallback）"}},
      pH: { light:["blue","藍燈"], rows:[["理想區","自動","--","標準"],["可接受","自動","--","標準"],["危險線","自動","--","標準"],["權重","自動","--","標準"]], ratio:{blue:35,green:55,yellow:10,orange:0,red:0},coveragePct:96,card:{title:"維持 pH 管理",badge:"",reason:"pH 24h 大多位於理想區。",action:"維持目前設定，依例行頻率巡檢 pH 變化。",effect:"水體緩衝狀態穩定。",impact:"不增加額外成本。信心：高"}},
      orpMv: { light:["green","綠燈"], rows:[["理想下限","自動","--","標準"],["後期理想","自動","--","標準"],["危險線","自動","--","標準"],["權重","自動","--","標準"]],ratio:{blue:12,green:66,yellow:22,orange:0,red:0},coveragePct:94,card:{title:"本週觀察底質",badge:"",reason:"ORP 7d 黃燈占比略升。",action:"安排進水/排汙檢查，防止底質惡化。",effect:"降低底質惡化風險。",impact:"增加少量管理成本。信心：中"}},
      salinityPpt: { light:["green","綠燈"],rows:[["理想區","自動","--","標準"],["偏好區","自動","--","標準"],["日變動","自動","--","標準"],["權重","自動","--","標準"]],ratio:{blue:18,green:68,yellow:14,orange:0,red:0},coveragePct:95,card:{title:"雨前監控鹽度",badge:"",reason:"24h 有降雨預測。",action:"維持水位並加密鹽度監測，防止鹽度急變。",effect:"降低鹽度急變風險。",impact:"暫無額外成本。信心：中"}},
      waterTempC: { light:["yellow","黃燈"],rows:[["理想區","自動","--","標準"],["警戒區","自動","--","標準"],["危險線","自動","--","標準"],["權重","自動","--","標準"]],ratio:{blue:10,green:60,yellow:30,orange:0,red:0},coveragePct:93,card:{title:"午後水溫注意",badge:"",reason:"水溫預測接近標準上緣。",action:"午後加開水車並觀察水位，防止耗氧升高。",effect:"降低耗氧壓力。",impact:"少量增加電力成本。信心：中"}}
    }}
  };
