    ...
    fisheries: {
      ...
      templates: {
        whiteShrimp: {
          ...
          sensorRequirements: [
            { id: "sensor-do", parameterId: "DO", requirement: "required", label: "DO 溶氧感測器", labelEn: "DO Sensor", unit: "mg/L", productImageUrl: "", productName: "JNC DO 感測器", productNameEn: "JNC DO Sensor", description: "白蝦低氧風險與水車控制核心資料。", descriptionEn: "Core input for low-oxygen risk and paddlewheel control." },
            { id: "sensor-ph", parameterId: "pH", requirement: "required", label: "pH 酸鹼值感測器", labelEn: "pH Sensor", unit: "", productImageUrl: "", productName: "JNC pH 感測器", productNameEn: "JNC pH Sensor", description: "追蹤酸鹼波動、雨後跌酸與藻相變化。", descriptionEn: "Tracks pH fluctuation, post-rain drops, and algae-related changes." },
            { id: "sensor-orp", parameterId: "orpMv", requirement: "required", label: "ORP 氧化還原電位感測器", labelEn: "ORP Sensor", unit: "mV", productImageUrl: "", productName: "JNC ORP 感測器", productNameEn: "JNC ORP Sensor", description: "輔助判斷底質惡化與還原性風險。", descriptionEn: "Supports bottom-condition and reductive-risk assessment." },
            { id: "sensor-salinity", parameterId: "salinityPpt", requirement: "required", label: "SC / 鹽度感測器", labelEn: "SC / Salinity Sensor", unit: "ppt", productImageUrl: "", productName: "JNC 鹽度感測器", productNameEn: "JNC Salinity Sensor", description: "監控鹽度變化與滲透壓壓力。", descriptionEn: "Monitors salinity change and osmotic stress." },
            { id: "sensor-water-temp", parameterId: "waterTempC", requirement: "required", label: "水溫感測器", labelEn: "Water Temperature Sensor", unit: "C", productImageUrl: "", productName: "JNC 水溫感測器", productNameEn: "JNC Water Temperature Sensor", description: "納入耗氧、攝食與成長風險判斷。", descriptionEn: "Feeds oxygen-demand, feeding, and growth-risk assessment." },
            { id: "sensor-nh4", parameterId: "NH4", requirement: "optional", sensorInstalled: false, label: "NH4/NH3 氨氮感測器", labelEn: "NH4/NH3 Sensor", unit: "mg/L", productImageUrl: "", productName: "JNC 氨氮感測器", productNameEn: "JNC Ammonia Sensor", description: "選配，強化氨毒性與水質惡化判斷。", descriptionEn: "Optional input for ammonia toxicity and water-quality deterioration." },
            { id: "sensor-no2", parameterId: "NO2", requirement: "optional", sensorInstalled: false, label: "NO2 亞硝酸感測器", labelEn: "NO2 Sensor", unit: "mg/L", productImageUrl: "", productName: "JNC 亞硝酸感測器", productNameEn: "JNC Nitrite Sensor", description: "選配，強化亞硝酸風險判斷。", descriptionEn: "Optional input for nitrite-risk assessment." },
            { id: "sensor-turbidity", parameterId: "turbidityNtu", requirement: "optional", sensorInstalled: false, label: "濁度感測器", labelEn: "Turbidity Sensor", unit: "NTU", productImageUrl: "", productName: "JNC 濁度感測器", productNameEn: "JNC Turbidity Sensor", description: "選配，輔助判斷水體懸浮物與透明度變化。", descriptionEn: "Optional input for suspended solids and clarity changes." }
          ],
          standardProfiles: {
            DO: [
    ...
    agriculture: {
      ...
      templates: {
        hydroponicVegetables: {
          ...
          parameters: [],
          sensorRequirements: [
            { id: "hydro-ec", parameterId: "EC", requirement: "required", label: "EC 營養液感測器", labelEn: "EC Sensor", unit: "mS/cm", productImageUrl: "", productName: "JNC EC 感測器", productNameEn: "JNC EC Sensor", description: "監控營養液濃度與肥培穩定度。", descriptionEn: "Monitors nutrient strength and fertigation stability." },
            { id: "hydro-ph", parameterId: "pH", requirement: "required", label: "pH 酸鹼值感測器", labelEn: "pH Sensor", unit: "", productImageUrl: "", productName: "JNC pH 感測器", productNameEn: "JNC pH Sensor", description: "監控營養液酸鹼與吸收風險。", descriptionEn: "Monitors nutrient-solution acidity and uptake risk." },
            { id: "hydro-water-temp", parameterId: "waterTempC", requirement: "required", label: "水溫感測器", labelEn: "Water Temperature Sensor", unit: "C", productImageUrl: "", productName: "JNC 水溫感測器", productNameEn: "JNC Water Temperature Sensor", description: "納入根區吸收、溶氧與病害風險判斷。", descriptionEn: "Supports root uptake, DO, and disease-risk assessment." },
            { id: "hydro-do", parameterId: "DO", requirement: "required", label: "DO 溶氧感測器", labelEn: "DO Sensor", unit: "mg/L", productImageUrl: "", productName: "JNC DO 感測器", productNameEn: "JNC DO Sensor", description: "監控根區溶氧與缺氧風險。", descriptionEn: "Monitors root-zone DO and hypoxia risk." },
            { id: "hydro-air-temp", parameterId: "airTempC", requirement: "required", label: "環境溫度感測器", labelEn: "Air Temperature Sensor", unit: "C", productImageUrl: "", productName: "JNC 環境溫度感測器", productNameEn: "JNC Air Temperature Sensor", description: "監控溫度壓力與抽苔/葉燒風險。", descriptionEn: "Monitors temperature stress, bolting, and tipburn risk." },
            { id: "hydro-humidity", parameterId: "humidityPct", requirement: "required", label: "環境濕度感測器", labelEn: "Humidity Sensor", unit: "%", productImageUrl: "", productName: "JNC 濕度感測器", productNameEn: "JNC Humidity Sensor", description: "支援 VPD 與蒸散壓力判斷。", descriptionEn: "Supports VPD and transpiration-stress assessment." },
            { id: "hydro-dli", parameterId: "DLI", requirement: "required", label: "光照 / DLI 感測器", labelEn: "Light / DLI Sensor", unit: "mol/m2/d", productImageUrl: "", productName: "JNC 光照感測器", productNameEn: "JNC Light Sensor", description: "監控光積量、補光與生長品質。", descriptionEn: "Monitors light integral, supplemental lighting, and growth quality." },
            { id: "hydro-co2", parameterId: "CO2", requirement: "optional", sensorInstalled: false, label: "CO2 感測器", labelEn: "CO2 Sensor", unit: "ppm", productImageUrl: "", productName: "JNC CO2 感測器", productNameEn: "JNC CO2 Sensor", description: "選配，輔助判斷光合效率。", descriptionEn: "Optional input for photosynthesis-efficiency assessment." },
            { id: "hydro-vpd", parameterId: "VPD", requirement: "optional", sensorInstalled: false, label: "VPD 感測器/計算參數", labelEn: "VPD Sensor / Derived Parameter", unit: "kPa", productImageUrl: "", productName: "JNC VPD 模組", productNameEn: "JNC VPD Module", description: "選配，整合溫濕度推估蒸散壓力。", descriptionEn: "Optional module deriving transpiration pressure from temperature and humidity." },
            { id: "hydro-camera", parameterId: "vision", requirement: "optional", sensorInstalled: false, label: "影像鏡頭", labelEn: "Vision Camera", unit: "", productImageUrl: "", productName: "JNC 影像模組", productNameEn: "JNC Vision Module", description: "選配，支援葉燒、黃化、根區與生長影像判讀。", descriptionEn: "Optional input for tipburn, yellowing, root-zone, and growth-image assessment." },
