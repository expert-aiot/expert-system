      ...
      templates: {
        whiteShrimp: {
          ...
          sensorRequirements: [
            ...
            { id: "sensor-camera", parameterId: "vision", requirement: "optional", sensorInstalled: false, label: "水下攝影機", labelEn: "Underwater Camera", unit: "", productImageUrl: "../assets/sensors/水下攝影機IWC.png", productName: "JNC 水下攝影機", productNameEn: "JNC Underwater Camera", description: "選配，提供蝦體影像、活動狀態與 AI 體長/成長估算資料。", descriptionEn: "Optional input for shrimp imagery, activity status, and AI growth estimation." }
          ],
          standardProfiles: {
            DO: [
      ...
      templates: {
        hydroponicVegetables: {
          ...
          sensorRequirements: [
            ...
            { id: "hydro-camera", parameterId: "vision", requirement: "optional", sensorInstalled: false, label: "影像鏡頭", labelEn: "Vision Camera", unit: "", productImageUrl: "../assets/sensors/雲端環境影像攝影機.png", productName: "JNC 影像模組", productNameEn: "JNC Vision Module", description: "選配，支援葉燒、黃化、根區與生長影像判讀。", descriptionEn: "Optional input for tipburn, yellowing, root-zone, and growth-image assessment." },
